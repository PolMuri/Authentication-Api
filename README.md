#  API developed with Python and Flask framework for managing user registrations. The API can be prepared and run in two ways: using Docker or directly with Flask.
